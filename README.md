...
## 📖 Overview
This project is a distributed microservices system that tracks Near-Earth Objects (NEOs) in real-time. It ingests data from NASA's API, calculates impact trajectories using a custom physics engine, and persists the data for analysis.
...
## 🏗 Architecture
This project uses a specialized Event-Driven Architecture (EDA) to decouple ingestion from processing.
